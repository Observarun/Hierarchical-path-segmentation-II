...
The methods developed here have been demonstrated on both simulated and empirical relocation data. The former has been generated using a two‐mode step‐selection kernel simulator called Numerus ANIMOVER_1 [[2]](#2). The empirical data is obtained using an ATLAS reverse GPS technology system at a relocation frequency of 0.25 Hz. It corresponds to a female barn owl (Tyto alba) individual, which is part of a population tagged at our study site in the Harod Valley in northeast Israel. The ANIMOV and owl datasets are available in my [Dryad repository](https://doi.org/10.5061/dryad.jm63xsjkv) as files multi-DAR_sim.csv and list-DARsAsDataframes_owl.Rmd respectively.
